...
* Then, in the command window, you can use
```
nohup python -u main.py --model_config 'base' --finetune_label_ratio 0.05 --r 32 --seed 16 --device "cuda:1"> training_ecg_seed16_base.log 2>&1 &
```
to run the FastECG algorithm.
